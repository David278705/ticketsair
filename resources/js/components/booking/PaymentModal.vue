                ...
                <div class="flex min-h-full items-center justify-center p-4">
                    ...
                    >
                        ...
                        >
                            ...
                            <p
                                v-if="generalError"
                                class="mt-4 text-sm text-rose-600 bg-rose-50 p-3 rounded-xl"
                            >
                                {{ generalError }}
                            </p>
                            ...
                            <!-- Seguridad -->
                            <div
                                class="mt-4 flex items-center justify-center gap-2 text-xs text-slate-500"
                            >
                                <svg
                                    class="w-4 h-4"
                                    fill="currentColor"
